...
% To define the \textbf{feature matrix}, often denoted as $\mathbf{X}$, and the \textbf{target vector}, $\mathbf{y}$:
...
% Its target target vector shall be:
% $$
% \mathbf{y} = \begin{Bmatrix}
% y_1 \\
% y_2 \\
...
% For the more complex feature matrix that includes the technical analysis indicators, which will be noted as \textit{ta}, it will take the following shape:
% $$
% \mathbf{X} = \begin{Bmatrix}
% x_1 & x_2 & x_3 & ta_{11} & ta_{21} & ... & ta_{n1}\\
% x_2 & x_3 & x_4 & ta_{12} & ta_{22} & ... & ta_{n2}\\
% x_3 & x_4 & x_5 & ta_{13} & ta_{23} & ... & ta_{nm}
% \end{Bmatrix}
% $$
