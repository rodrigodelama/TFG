...
% Get rid of all of this and discuss th
...
The regularization strength alpha controls how much the model penalizes large coefficients. Larger alpha, means more shrinkage (simpler model, potentially more bias).
