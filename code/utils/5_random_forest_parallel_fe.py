...
def main():
    ...
    for n_est in n_estimators:
        for max_d in max_depth:
            ...
            results_file = f"/Users/rodrigodelama/Library/Mobile Documents/com~apple~CloudDocs/uc3m/TFG/code/final_metrics/3_randomforest/random_forest_fe_results_n_estimators_{n_est}_max_depth_{max_d}.csv"
    ...
    comprehensive_gt_df.to_csv('/Users/rodrigodelama/Library/Mobile Documents/com~apple~CloudDocs/uc3m/TFG/code/final_metrics/3_randomforest/random_forest_full_fe_results_optimized.csv', index=False)
    print(f"\nFinal results saved to 'random_forest_full_fe_results_optimized.csv'")
