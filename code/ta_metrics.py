...
# Rolling window
# Considering a 7-day window as a test
rw = 7
...
df_hour.to_csv(f'data/ta_metrics/hour_{hour_to_predict}_metrics.csv', index=False)

# Output message
print(f"Metrics for hour {hour_to_predict} calculated and saved to 'data/ta_metrics/hour_{hour_to_predict}_metrics.csv'.")
